...
import net.chigita.gpstest.databinding.ActivityOrientationBinding
...
class OrientationActivity : AppCompatActivity(), SensorEventListener {
  ...
  private val binding by lazy {
    DataBindingUtil.setContentView<ActivityOrientationBinding>(this, R.layout.activity_orientation)
  }
